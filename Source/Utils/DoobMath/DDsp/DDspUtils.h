...
namespace DDsp {
    ...
    public:
        ...
        static DMath::DVectorComplex<Type> complexVectorMagnitude(const DMath::DVectorComplex<std::complex<Type>>& complexVector);

        // function to normalize a signal to a specified range
        static DMath::DVector<Type> normalizeSignal(const DMath::DVector<Type>& signal, Type minRange, Type maxRange);
        ...
        static DMath::DVector<Type> trimSignal(const DMath::DVector<Type>& signal, size_t start, size_t end);

        // function to zero pad a signal to a specified length
        static DMath::DVector<Type> zeroPadSignal(const DMath::DVector<Type>& signal, size_t paddedLength);
    };
